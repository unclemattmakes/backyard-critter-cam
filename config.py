...
class Config:
    ...
    # IRREPLACEABLE SOURCES -- footage that exists in exactly one place. The live rig can re-record
    # tomorrow; an SD card's video is gone the moment the card is formatted, and this author's card
